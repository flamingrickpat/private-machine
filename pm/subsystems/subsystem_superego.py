...
def execute_subsystem_superego(ctx_msgs: str, last_message: str) -> str:
...
You will focus on the interdependency of last message and {companion_name}'s personality and super-ego! Previous messages are only here for context, they have already been evaluated.
FOCUS ON THE LAST MESSAGE AND MAKE IT SHORT! MAXIMUM 4 SENTENCES!
"""

    layer = get_initial_dynamic_schema()
    gwt_output: List[CogEvent] = []
    subsystem = layer.get_subsystems(GwtLayer.superego)
    agents = []
    while True:

...
class FeatureType(StrEnum):
    ...
    def from_stimulus(feature_type):
        return feature_type == FeatureType.Dialogue or feature_type == FeatureType.Thought or feature_type == FeatureType.WorldEvent or feature_type == FeatureType.SystemMessage
    ...
    def initialize_tick_state(self, stimulus: Stimulus | None):
        ...
        if stimulus is not None:
            ...
            if stimulus.stimulus_type == StimulusType.UserMessage:
                ...
                story_feature = Feature(content=idea_str, source=companion_name, feature_type=FeatureType.Thought, interlocus=-1, causal=True)
                self.add_knoxel(story_feature)
            else:
                raise Exception()
